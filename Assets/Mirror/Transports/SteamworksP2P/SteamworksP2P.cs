...
namespace Mirror.SteamworksP2P
{
    public class SteamworksP2P : Transport
    {
        ...
        public override void ClientSend(ArraySegment<byte> segment, int channelId = 0) => throw new NotImplementedException();
        ...
        public override void ServerDisconnect(int connectionId) => throw new NotImplementedException();
        public override string ServerGetClientAddress(int connectionId) => throw new NotImplementedException();
        public override void ServerSend(int connectionId, ArraySegment<byte> segment, int channelId = 0) => throw new NotImplementedException();
